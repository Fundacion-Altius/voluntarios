...
### Requirement: deploy-v2 branch
**Reason**: Replaced by standardized dev branch as integration/staging environment
**Migration**: Merge deploy-v2 into dev, then delete deploy-v2 branch

### Requirement: build branch
**Reason**: Build artifacts should not be stored in git branches
**Migration**: Remove build branch and use CI/CD artifacts instead

### Requirement: Direct development in dev branch
**Reason**: All development must happen in isolated feature branches
**Migration**: Create feat/* branches for all new development work
...
Unit tests for the admin panel data-fetching hooks — `useUsers`, `useSurveys`, `useDashboardStats`, and admin `useContracts`. Ensures CRUD operations, search filtering, pagination, and error states are tested in isolation.

...
The system SHALL support the creation and management of volunteer activity types and sessions, including booking, check-in/check-out, waitlisting, and no-show penalty tracking.

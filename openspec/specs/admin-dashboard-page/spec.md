...
- **THEN** the line stroke SHALL use a theme-aware color that is distinct in both light and dark mode
...
- **THEN** the bar fill SHALL use a theme-aware color distinct in both light and dark mode
...
- **THEN** each slice SHALL use a distinct theme-aware color visible in both light and dark mode

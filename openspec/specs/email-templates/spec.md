...
The survey invitation email template includes volunteer name, survey link, and organization branding, loaded from a dedicated directory.

## Requirements

### Requirement: Survey invitation email template

The system SHALL provide an HTML email template for the survey invitation.
...
- **WHEN** the email is generated
- **THEN** the email body includes Fundación Altius branding colors

# Purpose
Provide automated CI/CD pipeline for the Next.js frontend using Vercel's native GitHub integration, with automatic production deployments on push and preview deployments for pull requests.
